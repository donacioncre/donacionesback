                      ...
                      <td align="left" style="font-size:0px;padding:10px 40px;word-break:break-word;">
                        <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;
                          ...
                          <p style="margin-bottom: 0;">
                            Hola, {{$data['name']}} {{$data['lastname']}} hemos recibido con éxito la cancelación para donar 
                            {{$data['donation_type']}}.
                      ...
                      <td align="left" style="font-size:0px;padding:10px 40px;word-break:break-word;">
                        <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;
                          ...
                          <p style="margin-bottom: 0;">
                            ...
                            IMPORTANTE: Para agendar una nueva cita abre a la APP SíDono e ingresa a tu perfil,
                            selecciona “Agendar Citas”.
                            <br>
                            <br>
