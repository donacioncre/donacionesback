                      ...
                      <td align="left" style="font-size:0px;padding:10px 40px;word-break:break-word;">
                        <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;
                          ...
                          <p style="margin-bottom: 0;">
                            Hola, {{$data['name']}} {{$data['lastname']}} hemos recibido con éxito el reagendamiento para
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 40px;word-break:break-word;">
                        <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;
                            line-height:20px;text-align:left">
                          <p style="margin-bottom: 0;">
                            Recuerda ir 10 minutos antes al centro de donación seleccionado, debes llevar tu cédula
                            de ciudadanía para ser atendido.
                            <br>
                            <br>
                            IMPORTANTE: Si deseas reagendar o cancelar la cita abre a la APP SíDono e ingresa a
                            tu perfil y en “Mis citas” puedes seleccionar la acción que deseas realizar.
                            <br>
                            <br>
